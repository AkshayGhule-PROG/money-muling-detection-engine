...
export default function Home() {
  ...
  async function onFile(file) {
    ...
    try {
      ...
      // Store results in localStorage for Analysis page
      // resultsData.data contains: { nodes, edges, rings, accounts, summary, timestamp }
      localStorage.setItem("analysis_result", JSON.stringify(resultsData.data));
      localStorage.setItem("analysis_rows", JSON.stringify(transactionRows));
